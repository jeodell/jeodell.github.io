...
export default function ProjectCard(props: ProjectCardProps) {
  ...
  return (
    <div className="group relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-white bg-opacity-50 opacity-0 transition-opacity group-hover:opacity-100">
        <button
          className="rounded-full bg-jo-light px-6 py-2 text-zinc-200"
